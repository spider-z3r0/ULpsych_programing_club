...
# Practice recap {.smaller}
 ...
 - Then write a function that takes in a `character`
   - The function should iterate over the `character` and print each symbol
   - The function should also print a message if the number of symbols is odd or even
 - Then call the function with a `character` of your choice
