...
movies_df_no_empty['genre'] = movies_df_no_empty['genre'].replace("Dark Comedy", "Comedy").str.lower()
print(movies_df_no_empty['genre'].value_counts())
...
additional_movies = {
    ...
    'imdB_score': [88, 75],
movies_df_extended['runtime'] = [120, 110, 130, 115, 95, 105, 123, 95, 121, 113, 148, 141]
print(movies_df_extended.head())

# Filter movies released after 2000
movies_post_2000 = movies_df_extended[movies_df_extended['year_of_release'].astype(int) > 2000]
print(movies_post_2000)

# Calculate and add average score column
movies_df_extended['average_score'] = (movies_df_extended['imdB_score'] + movies_df_extended['rotten_tomatoes_score']) / 2
print(movies_df_extended.head())
```
