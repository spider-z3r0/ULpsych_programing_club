...
movies_df_cleanv1.replace(r'^\s*$', np.nan, regex=True, inplace=True)
...
# Add Rows {.smaller}
 ...
 - It is quite easy to concatenate (remember that from the earlier sessions with strings?)
