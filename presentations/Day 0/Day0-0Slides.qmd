...
For most of human history, we’ve been trying to capt shareable form.

- **Caves** were good—but hard to carry.
  ![](images/cave.jpg){fig-align="center" height=250}

- **Scrolls** were elegant—but fragile.
  ![](images/scroll.jpg){fig-align="center" height=250}

- **Manuscripts** were beautiful—but time-consuming.
  ![](images/manuscript.jpeg){fig-align="center" height=250}

---

- **Printed books** were powerful—but required experts.
  ![](images/press.jpg){fig-align="center" height=250}

- **Word processors** made it easier—but brought new complexity.
  ![](images/word.jpg){fig-align="center" height=250}

- **The web** let us publish anything—but formatting it well became a whole new skill.
  ![](images/browser.jpg){fig-align="center" height=250}
