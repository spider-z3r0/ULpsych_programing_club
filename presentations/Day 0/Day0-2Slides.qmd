...
Depending on the operating system, and the language of the keyboard you need to type backticks differently; for example: 
 ...
 - On a *irish* windows keyboard the first time you press the key nothing happens...
  ...
  - If you press another key after the first backtick you get: 
   - a special character like a á or é
...
Here's an example of a code block: (ignore the backslashes for now, we'll talk about them in a second)
...
If it is one of the languages that Quarto knows about (like Python, R, or Julia) it will do a good job of formatting it for you, and it will even run the code for you (if you ask it to).
