...
## Extensions{.smaller}
### Updating the YAML
Once you've installed the extension you can use it in your document by updating the YAML.

Every extension will have it's own idosyncratic YAML options, but the 'apaquarto' extension has a few that make your life easier (as long as your aware of them)
