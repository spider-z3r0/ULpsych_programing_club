...
:::{.notes}
in the quarto document there's a lot of \\ in the address, that's the old fildpath problem again!
:::
...
### The Basics  
 ...
 - They have a `yaml` header at the top of the file (which is where you tell the computer how to format the document).
     - We'll talk more about `yaml` later, but for now just think of it as a set of instructions for the computer.
